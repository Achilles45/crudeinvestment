           ...
           <div class="dashboard__right">
             ...
             <hr>
              ...
              <div class="alert alert-success">
                  Please, contact admin for payment details or call  <a href="tel:08122069201">08122069201</a>
              </div>
                  ...
                  <div class="summary__card four pt-4">
                     ...
                     <div class="content pl-2">
                         ...
                         <hr>
                         <h6>Wallet Address: 3F2cCjzbGqgBpeBoDiZwDqdxniW9DbZ3Nm</h6>
                     </div>
                  </div>
              </div>
              </div>
              <hr>
              <div></div>
              <p>After making payment, please upload your proof of payment in your dashboard or send a mail to our support agent at crudeoilmarketing9@gmail.com so your payment can be immediately approved.</p>
              </div>
            <!--End of Dashboard
            =========================-->
              <br>
