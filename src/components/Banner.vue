      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
            <h1 class="animate__animated animate__bounceIn">EARN 40% of YOUR <span class="orange">INITIAL INVESTMENT IN 7 DAYS</span></h1>
            <p>You can grow your initial investment to as much as 40% in 7 working days, or 50% in 48 hours when you select our promo plans. No stories, no stress.</p>
        ...
        <div class="carousel-item">
          <div class="carousel-overlay"></div>
          <img class="carousel-img" src="../assets/images/slider2.jpg" alt="Second slide" />
          <div class="carousel-caption">
